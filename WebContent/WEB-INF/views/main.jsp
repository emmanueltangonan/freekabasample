    ...
    <div class="main-container">
        ...
        <div class="dude-board-header">
            ...
            <div class="dude-board-search">
	            ...
	            <form class="form-freekaba" action="Search" method="post">
	            ...
	            <a href="/FreeKaBa/App/api1">
	            <input id="api1-btn" class="ui-button ui-widget ui-corner-all" type="button" value="Click to Search Hangout Places using API">
	            </a>
